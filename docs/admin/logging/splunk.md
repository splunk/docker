...
| `splunk-format`             | optional | Message format. Can be `json` or `raw`. Defaults to `json`.                                                                                                                                                        |
| `splunk-verifyconnection`   | optional | Verify on start, that docker can connect to Splunk server. Defaults to true.                                                                                                                                       |
